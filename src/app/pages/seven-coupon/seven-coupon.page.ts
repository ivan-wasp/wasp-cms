...
import { SevenCouponType, UserData } from 'src/app/schema';
import { Observable } from 'rxjs';

@Component({
  selector: 'app-seven-coupon',
  templateUrl: './seven-coupon.page.html',
  styleUrls: ['./seven-coupon.page.scss'],
})
export class SevenCouponPage implements OnInit {
  sorting = null;
  direction = null;
  limit = null;
  page = null;
  ...
  getSevenCouponDataList(export_to_excel?: boolean) {
    if (!export_to_excel) {
    ...
    let send_data = {
      ...
      assigned: this.assigned != null && this.assigned != '' ? (this.assigned == 'true' ? true : false) : '',
