...
export class MaintenancePage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getMaintenanceDataList();
  }

  getMaintenanceDataList() {
    ...
    this.apiService.postFromServer(ApiPath.get_maintenance_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {
      let new_path = `/maintenance?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}`;
