...
export class NotificationPage implements OnInit {
  ...
  getNotificationDataList() {
    ...
    this.apiService.postFromServer(ApiPath.get_notification_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {
      let new_path = `/notification?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}`;
