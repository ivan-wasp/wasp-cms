...
export class FaqPage implements OnInit {
  ...
  getFaqDataList() {
    ...
    this.apiService.postFromServer(ApiPath.get_faq_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {
      let new_path = `/faq?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}`;
