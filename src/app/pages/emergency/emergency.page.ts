...
import { EmergencyStatus, UserData } from 'src/app/schema';
...
export class EmergencyPage implements OnInit {
  ...
  public get emergencyStatus(): typeof EmergencyStatus {
  ...
  getEmergencyDataList(export_to_excel?: boolean) {
    ...
    this.apiService.postFromServer(ApiPath.get_emergency_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {
      ...
      let new_path = `/emergency?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}&status=${this.status}&user_id=${this.user_id||''}`;
