...
export class ProductPage implements OnInit {
  ...
  getProductDataList() {
    ...
    this.apiService.postFromServer(ApiPath.get_product_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {
      let new_path = `/product?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}`;
