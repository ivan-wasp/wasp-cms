...
export class FactoryPage implements OnInit {
  ...
  getFactoryDataList() {
    ...
    this.apiService.postFromServer(ApiPath.get_factory_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {

      let new_path = `/factory?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}`;
