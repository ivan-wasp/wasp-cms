...
export class LogPage implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.getLogDataList();
    this.dataService.table_data_list = [];
    this.dataService.table_data_total_number = 0;
    this.dataService.table_data_number_of_page = 1;
  }
  ...
  getLogDataList() {
    ...
    this.apiService.postFromServer(ApiPath.get_log_data_and_total_number_by_sorting_and_limit_or_search, send_data, true).then((res: Response) => {
      let new_path = `/log?page=${this.page}&limit=${this.limit}&sorting=${this.sorting}&direction=${this.direction}`;
